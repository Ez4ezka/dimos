...
Stands in for a real A8 capture until one is recorded on the bench; the RtspCamera
replay path treats a file exactly like the RTSP stream apart from the transport.
"""
