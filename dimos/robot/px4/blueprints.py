...
def _px4_rerun_blueprint() -> Any:
    """3D world over the video, the setpoint and battery traces and the status log.
...
# the GPS fix is a map layer the dimos-viewer build does not include.
_RERUN_VISUAL_OVERRIDE = {"world/color_image": None, "world/gps": None}
