...
# Stop commands are scored on the setpoint stream ending; anything else that is accepted
# is scored on the odometry response to its setpoints, or closed at once if it moves
# nothing by design.
