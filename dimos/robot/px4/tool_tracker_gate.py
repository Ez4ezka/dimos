...
"""Tracker gate: four scripted operator commands through the real transports, no simulator.

A fake connection module replays what Px4DroneConnection would publish for this
sequence: W held 2 s, A tapped, W while in HOVER, W while E-STOP is latched.
