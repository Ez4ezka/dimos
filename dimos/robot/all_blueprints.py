...
all_blueprints = {
    ...
    "coordinator-trajectory-xarm6": "dimos.robot.manipulators.xarm.blueprints.teleop:coordinator_trajectory_xarm6",
    ...
    "px4-agentic": "dimos.robot.px4.blueprints_agentic:px4_agentic",
    "px4-basic": "dimos.robot.px4.blueprints:px4_basic",
    "px4-drone": "dimos.robot.px4.blueprints:px4_drone",
    "px4-follow": "dimos.robot.px4.blueprints_follow:px4_follow",
    "px4-sitl": "dimos.robot.px4.blueprints:px4_sitl",
    "px4-sitl-agentic": "dimos.robot.px4.blueprints_agentic:px4_sitl_agentic",
    "px4-sitl-follow": "dimos.robot.px4.blueprints_follow:px4_sitl_follow",
    ...
    "rtsp-camera-vis": "dimos.hardware.sensors.camera.rtsp.blueprints:rtsp_camera_vis",
    ...
    "teleop-webxr-rerun": "dimos.teleop.webxr.blueprints:teleop_webxr_rerun",
    ...
    "unitree-go2-cockpit": "dimos.robot.unitree.go2.blueprints.smart.unitree_go2_cockpit:unitree_go2_cockpit",
...
all_modules = {
    ...
    "arm-teleop-module": "dimos.teleop.webxr.extensions.ArmTeleopModule",
    ...
    "dan-local-planner": "dimos.navigation.experimental.dannav.local_planner.module.DanLocalPlanner",
    ...
    "fake-a8": "dimos.robot.px4.sitl.FakeA8",
    ...
    "g1-manipulation-module": "dimos.robot.unitree.g1.blueprints.basic.unitree_g1_teleop.G1ManipulationModule",
    ...
    "go2-relocalization": "dimos.mapping.relocalization.go2.module.Go2Relocalization",
    "go2-teleop-module": "dimos.teleop.webxr.extensions.Go2TeleopModule",
    ...
    "mls-planner-native": "dimos.navigation.global_planner.mls_planner.mls_planner_native.MLSPlannerNative",
    ...
    "patrolling-module": "dimos.navigation.experimental.patrolling.module.PatrollingModule",
    "perceive-loop-skill": "dimos.perception.experimental.perceive_loop_skill.PerceiveLoopSkill",
    "perception-bridge": "dimos.robot.px4.perception_bridge.PerceptionBridge",
    ...
    "px4-skill-container": "dimos.robot.px4.skill_container.Px4SkillContainer",
    ...
    "replanning-a-star-planner": "dimos.navigation.go2.replanning_a_star.module.ReplanningAStarPlanner",
    ...
    "rtsp-camera": "dimos.hardware.sensors.camera.rtsp.camera.RtspCamera",
    ...
    "siyi-a8-gimbal": "dimos.hardware.gimbal.siyi.gimbal.SiyiA8Gimbal",
    ...
    "start-relay": "dimos.navigation.global_planner.mls_planner.start_relay.StartRelay",
    "static-tf-publisher": "dimos.protocol.tf.static_tf_publisher.StaticTfPublisher",
    "teleop-control-coordinator": "dimos.control.teleop_coordinator.TeleopControlCoordinator",
    ...
    "wavefront-frontier-explorer": "dimos.navigation.experimental.frontier_exploration.wavefront_frontier_goal_selector.WavefrontFrontierExplorer",
    "web-input": "dimos.agents.web_human_input.WebInput",
    "web-xr-teleop-module": "dimos.teleop.webxr.module.WebXRTeleopModule",
