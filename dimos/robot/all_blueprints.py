...
all_blueprints = {
    ...
    "px4-basic": "dimos.robot.px4.blueprints.basic.px4_basic:px4_basic",
    "px4-bench": "dimos.robot.px4.blueprints.bench.px4_bench:px4_bench",
    "px4-field": "dimos.robot.px4.blueprints.field.px4_field:px4_field",
    "px4-sitl": "dimos.robot.px4.blueprints.basic.px4_sitl:px4_sitl",
    "px4-sitl-bench": "dimos.robot.px4.blueprints.bench.px4_sitl_bench:px4_sitl_bench",
    "px4-sitl-field": "dimos.robot.px4.blueprints.field.px4_field:px4_sitl_field",
    "px4-sitl-follow": "dimos.robot.px4.blueprints.basic.px4_sitl:px4_sitl_follow",
    "px4-sitl-perception": "dimos.robot.px4.blueprints.perception.px4_sitl_perception:px4_sitl_perception",
    "px4-sitl-tracked": "dimos.robot.px4.blueprints.verify.px4_sitl_tracked:px4_sitl_tracked",
    ...
    "siyi-a8-gimbal-vis": "dimos.hardware.gimbal.siyi.blueprints:siyi_a8_gimbal_vis",
...
all_modules = {
    ...
    "start-relay": "dimos.navigation.nav_3d.mls_planner.start_relay.StartRelay",
