...
class BatteryState(Timestamped):
    ...
    power_supply_health: int = POWER_SUPPLY_HEALTH_UNKNOWN
    power_supply_technology: int = POWER_SUPPLY_TECHNOLOGY_UNKNOWN
    present: bool = False
    ...
    @classmethod
    def lcm_decode(cls, data: bytes, **kwargs: Any) -> BatteryState:
